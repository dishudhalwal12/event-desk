...
import {
  getFirestoreInitializationOptions,
  isFirestoreCompatibilityModeActive
...
const useForcedLongPolling = isFirestoreCompatibilityModeActive();
const db = initializeFirestore(app, getFirestoreInitializationOptions());
